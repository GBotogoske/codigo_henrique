...
void MyMinuitFit_crosstalk() 
{
	...
	Double_t step[2] = {1e-6,1e-6};
	minuit->mnparm(0, "par0", vstart[0], step[0], p-0.01, p+0.01, ierr);
	minuit->mnparm(1, "par1", vstart[1], step[1], lambda-0.1, lambda+0.1, ierr);
